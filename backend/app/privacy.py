...
def normalize_longitude(longitude: float) -> float:
    """Wrap a longitude into [-180, 180) so an offset across the antimeridian stays valid."""
...
def public_coordinates(sighting):
    ...
    # Latitude is clamped rather than reflected so a polar find never jumps hemisphere.
