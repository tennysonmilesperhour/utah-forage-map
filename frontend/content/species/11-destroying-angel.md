...
taxon_id: 125390
summary: A deadly white Amanita pattern defined by free white gills, a ring, white spores, and a buried sack-like volva.
edibility: deadly
difficulty: expert-only
season: Summer through fall in eastern North America
habitat: Woodland soil near host trees
underside: Free white gills
spore_print: White
warning: Potentially fatal. If ingestion is possible, call Poison Control immediately before symptoms appear.
author: Mushroom Forage Map field desk
reviewer: Expert review pending
last_reviewed: 2026-08-15
image:
  url: https://inaturalist-open-data.s3.amazonaws.com/photos/330361432/large.jpg
...
lookalikes:
  ...
  - name: White Parasol
    severity: deadly
    check: Dig up the entire base. A buried sack-like volva is the critical Amanita warning.
---
...
- [iNaturalist taxon reference](https://www.inaturalist.org/taxa/125390)
