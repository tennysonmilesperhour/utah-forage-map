...
aliases: Pearl oyster
taxon_id: 48494
summary: Pale fan-shaped caps growing in shelves on wood, with gills descending a short off-center stem.
edibility: edible
...
lookalikes:
  ...
  - name: Crepidotus species
    severity: caution
    check: These are often smaller and produce a brown spore print rather than a pale one.
---
...
Oysters are good cooked edibles and one of the easiest mushrooms to cultivate on straw, sawdust blocks, or prepared kits. Claims about cholesterol and medicinal effects remain research questions, not reasons to self-treat. Oyster mycelium is also studied for environmental remediation.
